...
//_MENUS INICIALES____________________
int Iniciar()
{
...
//FUNCIONES DE VALIDACION_____________
int Validar_Fecha(date F)
{
...
//__FUNCIONES PARA T_RESERVA __________________________
...
//SUB-FUNCIONES DE SCANRESERVA()________________________
...
//_FUNCIONES PARA VECTORES DE T_RESERVA___________
...
//_FUNCIONES PARA ARCHIVOS-VECTORES_________________________
...
//_FUNCIONES TONTAS__________________
void Enter()
{
	while(getchar() != '\n');
}
