...
void Scan_Fecha(re *PtrReserva)
{
    do
    {
        ...
        printf("dia: %i\n", (*PtrReserva).Entrada.dd);
        printf("mes: %i\n", (*PtrReserva).Entrada.mm);
        printf("anio: %i\n", (*PtrReserva).Entrada.aa);
    ...
    // debe modificar date y devolver los ints
}
...
int Validar_Rango_Fecha(date EntradaUno, date SalidaUno, date EntradaDos, date SalidaDos)
{
    ...
    int RelacionE2_S1 = Comparar_Fechas(EntradaDos, SalidaUno);
    int RelacionE1_S2 = Comparar_Fechas(EntradaDos, SalidaUno);
